...
public class UserKernel extends ThreadedKernel {
    ...
    public static LinkedList<Integer> alloc(int n){
        LinkedList<Integer> ret = new LinkedList<Integer>();
        availablePagesLock.acquire();
        if(availablePages.size() >= n){
            for(int i = 0; i < n; i++){
                ret.push(availablePages.pop());
            }
        }
    ...
    public static int free(int ppn){
        //if we double-free a page bad things might happen. since the user cant manually free memory it's okay.
        availablePagesLock.acquire();
    ...
    private static Lock availablePagesLock;
