...
public class KThread {
    ...
    public static void joinTest() {
        new KThread(new Runnable() {
            public void run() {
                System.out.println("joinTest outer begins");
                KThread inner = new KThread(new Runnable() {
                    public void run() {
                        System.out.println("joinTest inner begins");
                        for (int i = 0; i < 1000000; i++) {
                            // wait a while
                        }
                        System.out.println("joinTest inner ends");
                    }
                }).setName("joinTestinner");
                inner.fork();
                inner.join();
                System.out.println("joinTest outer ends");
            }
        }).setName("joinTest").fork();
    }
    ...
    private Semaphore finishedExecuting = new Semaphore(0);
